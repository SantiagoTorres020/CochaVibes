...
{
    public class ActualizarComentarioDtoValidator : AbstractValidator<ComentarioDto>
    {
        public ActualizarComentarioDtoValidator()
        {
            RuleFor(x => x.IdComentario)
                .GreaterThan(0).WithMessage("El ID del comentario debe ser mayor que cero.");
